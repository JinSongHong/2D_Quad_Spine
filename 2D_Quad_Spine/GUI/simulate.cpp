...
void MakeGroupSection(mj::Simulate* sim, int oldstate) {
  mjuiDef defGroup[] = {
    ...
    {mjITEM_CHECKBYTE,  "Geom 0",           2, sim->opt.geomgroup,          },
    {mjITEM_CHECKBYTE,  "Geom 1",           2, sim->opt.geomgroup+1,        },
    {mjITEM_CHECKBYTE,  "Geom 2",           2, sim->opt.geomgroup+2,        },
    {mjITEM_CHECKBYTE,  "Geom 3",           2, sim->opt.geomgroup+3,        },
    {mjITEM_CHECKBYTE,  "Geom 4",           2, sim->opt.geomgroup+4,        },
    {mjITEM_CHECKBYTE,  "Geom 5",           2, sim->opt.geomgroup+5,        },
...
//   const mjuiDef defControlFlag[] = {
//     {mjITEM_SECTION,   "Control ON/OFF",       1, NULL,             ""},
//     {mjITEM_CHECKINT,   "RWDOB",       1,  &CP.RWDOB_flag,    ""},
//     {mjITEM_CHECKINT,   "Ori DOB",       1,  &CP.Orientation_DOB_flag,    ""},
//     {mjITEM_CHECKINT,   "Admittance",       1,  &CP.Admittance_flag,    ""},
    
//     {mjITEM_END}
//   };
//   mjui_add(&sim->ui1, defControlFlag);

//   const mjuiDef defReference[] = {
//     {mjITEM_SECTION,   "Reference",       1, NULL,             ""},
//     {mjITEM_EDITNUM,   "X veloicty",       2,  &CP.ref_trunk_vel[0],    "1"},
//     {mjITEM_EDITNUM,   "Y veloicty",       2,  &CP.ref_trunk_vel[1],    "1"},
//     {mjITEM_EDITNUM,   "Z veloicty",       2,  &CP.ref_trunk_vel[2],    "1"},
    
//     {mjITEM_END}
//   };
//   mjui_add(&sim->ui1, defReference);

//   const mjuiDef defControlPanel[] = {
//     {mjITEM_SECTION,   "Control parameter",       1, NULL,             ""},
//     {mjITEM_EDITNUM,   "RWDOB cutoff",       2, &CP.RWDOB_cutoff,    "1"},
//     {mjITEM_EDITNUM,   "OriDOB cutoff",       2, &CP.Orientation_DOB_cutoff,    "1"},
//     {mjITEM_END}
//   };
